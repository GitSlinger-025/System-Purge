...
* 🔒 **Privacy Shield:** Limits Windows Telemetry and background data tracking safely.
* ⚡ **Performance Boost:** Unlocks the "Ultimate Performance" power plan and reduces GUI latency.
* 🌐 **Network Optimizer:** Sets Google DNS for lower ping and faster browsing.
...
* **Auto-Admin Elevation:** Automatically requests administrative privileges.

## 💻 Quick Run (One-Liner)
Open **PowerShell as Administrator** and run the following command:

```powershell
iwr -useb [https://raw.githubusercontent.com/GitSlinger-025/System-Purge/main/SystemPurge.ps1](https://raw.githubusercontent.com/GitSlinger-025/System-Purge/main/SystemPurge.ps1) | iex
